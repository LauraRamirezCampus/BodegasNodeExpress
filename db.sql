...
CREATE DATABASE prueba_gb;
USE prueba_gb;

drop DATABASE prueba_gb;
...
ADD
    CONSTRAINT fk_bodegaOrigen FOREIGN KEY (id_bodega_origen) REFERENCES bodegas(id),
ADD
    CONSTRAINT fk_bodegaDestino FOREIGN KEY (id_bodega_destino) REFERENCES bodegas(id),
ADD
    CONSTRAINT fk_historial_inventario FOREIGN KEY (id_inventario) REFERENCES inventarios(id),
ADD
    CONSTRAINT fk_creado_por FOREIGN KEY (created_by) REFERENCES users(id),
ADD
    CONSTRAINT fk_actualizado_por FOREIGN KEY (update_by) REFERENCES users(id);

ALTER TABLE inventarios
ADD
    CONSTRAINT fk_bodega FOREIGN KEY (id_bodega) REFERENCES bodegas(id),
ADD
    CONSTRAINT fk_producto FOREIGN KEY (id_producto) REFERENCES productos(id),
ADD
    CONSTRAINT fk_inventarioCreado FOREIGN KEY (created_by) REFERENCES users(id),
ADD
    CONSTRAINT fk_inventarioActualizado FOREIGN KEY (update_by) REFERENCES users(id);

ALTER TABLE productos
ADD
    CONSTRAINT fk_productoCreado FOREIGN KEY (created_by) REFERENCES users(id),
ADD
    CONSTRAINT fk_productoActualizado FOREIGN KEY (update_by) REFERENCES users(id);

ALTER TABLE bodegas
ADD
    CONSTRAINT fk_bodega_Responsable FOREIGN KEY (id_responsable) REFERENCES users(id),
ADD
    CONSTRAINT fk_bodegaCreado FOREIGN KEY (created_by) REFERENCES users(id),
ADD
    CONSTRAINT fk_bodegaActualizado FOREIGN KEY (update_by) REFERENCES users(id);
